...
public class HeapPage implements Page {
    ...
    */
    private int getNumTuples() {
        ...
        // BufferPool.getPageSize()*8 = num of bits
        // tuple_size * 8 + 1 = size of each tuple
    ...
    private int getHeaderSize() {
        double headerSize = Math.ceil(numSlots / 8.0);  // /8.0 because headerSize is in bytes. numSlots -> 1 bit per slot
